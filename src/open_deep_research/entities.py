...
# =============================================================================
# Fiscal Year End Metadata (OPTIONAL - for display only)
# =============================================================================
# 
# NOTE: This is NOT required for XBRL extraction. XBRL uses fiscal_year and
# fiscal_period directly from the API data. This map is only for display
# purposes and can be safely incomplete.
#
# Most companies use December. Notable exceptions cached here for convenience:
# =============================================================================

FISCAL_YEAR_ENDS: Dict[str, str] = {
    # Non-December fiscal years (common exceptions)
    "NVDA": "January",    # NVIDIA
    "AAPL": "September",  # Apple
    "MSFT": "June",       # Microsoft
    "AVGO": "October",    # Broadcom
    "ADBE": "November",   # Adobe
    "ORCL": "May",        # Oracle
    "NKE": "May",         # Nike
    "FDX": "May",         # FedEx
    "WMT": "January",     # Walmart
    "COST": "August",     # Costco
    "HD": "January",      # Home Depot
    "CRM": "January",     # Salesforce
    
    # December fiscal years (majority - cached for performance)
    "GOOGL": "December",
    "GOOG": "December",
    "AMZN": "December",
    "META": "December",
...
def get_fiscal_year_end(ticker: str) -> Optional[str]:
    """
    Get fiscal year end month for a ticker (if known).
    
    NOTE: This is OPTIONAL metadata. XBRL extraction works without it
    because SEC XBRL API provides fiscal_year/fiscal_period directly.
    
    Args:
        ticker: Stock ticker symbol
        
    Returns:
        Month name (e.g., "January", "September") if known, None otherwise
        
    Example:
        >>> get_fiscal_year_end("NVDA")
        'January'
        >>> get_fiscal_year_end("UNKNOWN_TICKER")
        None
    """
    ticker_upper = ticker.upper()
    return FISCAL_YEAR_ENDS.get(ticker_upper)
